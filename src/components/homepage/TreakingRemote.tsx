...
const TreakingRemote = () => {
  return (
    <>
      ...
      <img className="absolute hidden lg:block bottom-[-10%] start-0 z-[-1]" src={box_img} alt="box-img" />
        <div className="container xl:max-w-[1140px] 3xl:max-w-[1320px] mx-auto px-5 xl:px-0">
          ...
          <div className="lg:w-6/12 mx-auto sm:w-10/12">
                <img className="w-full min-h-[207px]" src={tracking_img}  alt="tracking" />
            </div>
            <div className="lg:w-6/12 px-4 lg:ps-12">
              ...
              <p className="font-normal text-sm opacity-70 mb-5 sm:mb-9">Enhance patient care with remote monitoring, and enable providers to generate over $160 per patient per month in additional revenue</p>
