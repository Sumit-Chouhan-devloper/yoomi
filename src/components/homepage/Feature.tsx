        ...
        <div className="container xl:max-w-[1140px] 3xl:max-w-[1320px] mx-auto px-5 xl:px-0">
          ...
          <div className="flex lg:h-[550px] flex-wrap flex-col-reverse items-center lg:flex-row justify-between CommonCardShado py-10 lg:py-[80px] ps-4 pe-4 lg:pe-0">
            <div className="lg:w-5/12">
              ...
              <button className="rounded hover:bg-transparent hover:text-deep-blue hover:border-deep-blue transition duration-300
              px-4 sm:px-0 h-[45px] sm:h-[51px] sm:w-[164px] bg-deep-blue text-white font-semibold text-sm border border-transparent">
                View the Library
              </button>
            </div>
