      ...
      <section className="sm:py-12 py-8">
        <div className="container xl:max-w-[1140px] 3xl:max-w-[1320px] mx-auto px-5 xl:px-0">
          <div className="flex flex-wrap flex-col-reverse lg:flex-row common_card_shado py-10 lg:py-14 lg:items-center relative">
            <img className="absolute bottom-0 start-0 hidden lg:block" src={box_group} alt="cube" />
            <div className="lg:w-5/12 lg:ps-[34px] lg:pe-9 px-4">
              ...
              <p className="font-normal text-sm opacity-70 mb-5 sm:mb-9 relative">Track patient progress over time with compliance, pain, RPE, ROM and other key metrics</p>
              ...
              <div className="lg:w-7/12 mx-auto sm:w-10/12">
                <img className="w-full min-h-[228px]" src={Reporting_img}  alt="tracking" />
            </div>
          </div>
        </div>
      </section>
