  ...
  return (
    <>
      <div className="container xl:max-w-[1140px] mx-auto px-5 xl:px-0 text-center sm:py-10 py-[30px] lg:pb-[113px] lg:pt-[118px]">
        <p
          className="text-deep-blue text-sm font-medium uppercase pt-5 sm:pt-0"
          data-aos="fade-down"
        >
          Partners
        </p>
        ...
        <div className="flex justify-center min-[1025px]:justify-between] mt-4 sm:mt-9 gap-5 flex-wrap">
          <div className="mt-2sm:mt-4 flex justify-center items-center w-[150px] sm:w-[207px] h-[110px] sm:h-[137px] rounded-[4px] border-solid border-[1px] border-[rgba(0, 0, 0, 0.10)] shadow-lg shadow-[0px_13px_18px_0px_rgba(0, 0, 0, 0.06)] bg-white hover:shadow-[unset] duration-300 ease-linear" data-aos="zoom-in">
            <img
