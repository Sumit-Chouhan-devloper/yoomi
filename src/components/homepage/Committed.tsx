...
const Committed = () => {
  return (
    <>
      <div className=" lg:py-[83px] py-[30px] sm:py-10">
            ...
            <div className="xl:w-5/12 lg:w-6/12"data-aos="fade-left">
              <div className="flex lg:items-center  flex-col md:flex-row mt-9 lg:mt-0">
                <div className="md:me-[34px] sm:flex lg:flex-col md:gap-0 sm:gap-[34px]">
                  <div className="h-[170px] w-[170px] sm:h-[208px] sm:w-[208px] flex justify-center items-center commited_card box-shadow: 0px 26px 27px 0px rgba(0, 0, 0, 0.04), 0px -16px 27px 0px rgba(0, 0, 0, 0.04); rounded bg-white border border-solid border-[#E6F0F3] duration-300 ease-linear">
                    <img src={Images.committedLogoHippa} alt="logo" />
                  </div>
                  <div className="sm:h-[208px] h-[170px] w-[170px] lg:mt-[34px] mt-6 sm:mt-0 md:ms-[34px] commited_card box-shadow: 0px 26px 27px 0px rgba(0, 0, 0, 0.04), 0px -16px 27px 0px rgba(0, 0, 0, 0.04); lg:ms-0 flex justify-center items-center sm:w-[208px] rounded bg-white border border-solid border-[#E6F0F3] duration-300 ease-linear">
                    <img src={Images.committedLogoFda} alt="logo" />
                  </div>
                </div>
                <div className="flex justify-center mt-6 sm:mt-[34px] md:mt-0">
                  <div className="sm:h-[208px] h-[170px] w-[170px] sm:w-[208px] flex justify-center commited_card box-shadow: 0px 26px 27px 0px rgba(0, 0, 0, 0.04), 0px -16px 27px 0px rgba(0, 0, 0, 0.04); items-center rounded bg-white border border-solid border-[#E6F0F3] duration-300 ease-linear">
